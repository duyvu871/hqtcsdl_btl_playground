"""OpenRouter LLM fallback cho NER — chỉ gọi khi rules không đủ."""
...
from src.pipeline.ner.registry import CoinRegistry, filter_allowed_coin_ids
...
class OpenRouterNER:
    def __init__(
        ...
        *,
        ...
        self.model = model or settings.openrouter_model_resolved
        ...
        self._client = OpenAI(
            ...
            timeout=timeout,
            default_headers={"X-Title": "crypto-social-intelligence"},
        )
