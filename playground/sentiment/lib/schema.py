"""Schema builder — chuyển mapped_event + sentiment_result → sentiment_event."""
...
def normalize_timestamp(value: Any) -> int | None:
    """Chuẩn hoá timestamp về Unix epoch int.
...
def build_sentiment_event(
    ...
    """Tạo document sentiment_event từ input event + kết quả scoring."""
    doc: dict[str, Any] = {
