...
Lưu kết quả điểm số vào Redis để các module (như Scoring Engine) truy xuất với độ trễ thấp (Low-latency).
...
### Cách chạy
Khởi chạy Worker ở chế độ Production (Lắng nghe Kafka 24/7):
uv run main.py
